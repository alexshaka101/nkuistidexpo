...
export default function AboutPage() {
  return (
    <div className="min-h-screen">
      ...
      <main className="relative aspect-[9/16] md:aspect-video px-4 sm:px-6 lg:px-8 overflow-hidden flex items-center justify-center bg-[#C2000B]">
        <div className="max-w-3xl mx-auto">
          <div className="text-center space-y-8">
            ...
            <div className="space-y-6 text-lg text-neutral-300 leading-relaxed text-pretty">
              ...
              <p>我們共享著相同的課程、相近的設計語彙與基礎邏輯，這便是「同形」；然而，透過對材料的感知、對結構的辯證、對造型的琢磨，我們在不斷的碰撞與重組中，生長出截然不同的作品樣態，這便是「異構」</p>
              <p>我們將學習的過程具象化為「邊角」的增加。每一次技能的習得，都是在為人生這個多邊形刻劃新的支點</p>
